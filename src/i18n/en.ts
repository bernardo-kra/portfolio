const en = {
  ...
  footerTagline: 'Frontend Developer specialized in React and TypeScript',
  footerQuickLinks: 'Quick Links',
  footerConnect: 'Connect',
  footerBuiltWith: 'Built with React + TypeScript + Vite + CSS Modules',
  aboutMeMetrics: {
    experience: 'Years of Experience',
    experienceDesc: 'Frontend Development',
  ...
  aboutMeAchievements: {
    ...
    frontendDesc: 'Modern and responsive interfaces',
    architecture: 'Software Architecture',
    architectureDesc: 'Reusable and scalable components',
  ...
  workExperience: {
    ...
    experiences: [
      ...
      {
        id: 'sertao',
        company: 'Municipality of Sertão',
        location: 'Sertão - RS',
